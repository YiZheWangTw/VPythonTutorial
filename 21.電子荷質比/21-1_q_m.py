...
"""
 1. 參數設定, 設定變數及初始值
    (1) 向上撞到平行帶電板 v0 = 20, q = -2E-9, V = 1, d = 0.1
    (2) 向上但不會撞到平行帶電板 v0 = 20, q = -1E-9, V = 1, d = 0.1
    (3) 向上但不會撞到平行帶電板 v0 = 25, q = -2E-9, V = 1, d = 0.1
    (4) 向下撞到平行帶電板 v0 = 20, q = 2E-9, V = 1, d = 0.1
    (5) 向下但不會撞到平行帶電板 v0 = 20, q = 1E-9, V = 1, d = 0.1
    (6) 向下但不會撞到平行帶電板 v0 = 25, q = 2E-9, V = 1, d = 0.1
"""
