...
planet = sphere(pos = vector(d, 0, 0), radius = size, texture = textures.earth, make_trail = True, trail_color = color.blue, trail_radius = 0.1*size)
...
# 產生繪圖視窗
gdr = graph(title = "r-t plot", width = 600, height = 450, x = 0, y = 600, xtitle = "t(s)", ytitle = "r(m)")
gdv = graph(title = "v-t plot", width = 600, height = 450, x = 0, y = 1050, xtitle = "t(s)", ytitle = "v(m/s)")
gda = graph(title = "a-t plot", width = 600, height = 450, x = 0, y = 1500, xtitle = "t(s)", ytitle = "a(m/s^2)")
