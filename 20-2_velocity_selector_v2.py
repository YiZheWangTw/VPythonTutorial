...
p1 = box(pos = vector(0, d/2, 0), length = L, height = 0.01*L, width = L, color = color.blue)
p2 = box(pos = vector(0, -d/2, 0), length = L, height = 0.01*L, width = L, color = color.blue)
b1 = box(pos = vector(L/2, d/4 + size, 0), length = 0.01*L, height = d/2, width = L, color = color.gray(0.7))
b2 = box(pos = vector(L/2, -d/4 - size, 0), length = 0.01*L, height = d/2, width = L, color = color.gray(0.7))
