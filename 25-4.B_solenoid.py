...
"""
 2. 畫面設定
    ...
    (3) 用 cylinder 物件產生一小段導線 http://www.glowscript.org/docs/VPythonDocs/cylinder.html
...
points = []
for i in range(n):
    points.append(sphere(pos = vector(L/2 - i*L/n, r*cos(2*pi/n*num*i), r*sin(2*pi/n*num*i)), radius = point_size, color = color.cyan))
